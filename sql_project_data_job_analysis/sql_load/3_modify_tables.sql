...
\copy company_dim
FROM 'C:\Users\sasmi\Downloads\csv_files-20251110T010445Z-1-001\csv_files\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_dim
FROM 'C:\Users\sasmi\Downloads\csv_files-20251110T010445Z-1-001\csv_files\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
...
\copy skills_job_dim
FROM 'C:\Users\sasmi\Downloads\csv_files-20251110T010445Z-1-001\csv_files\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
